...
$architex_blog_date = get_theme_mod( 'architex_blog_date', true );
$architex_blog_comments = get_theme_mod( 'architex_blog_comments', true );
$architex_blog_author = get_theme_mod( 'architex_blog_author', true );
$architex_blog_cat = get_theme_mod( 'architex_blog_cat', false );

?>

<div class="post-meta">
    <?php if ( !empty($architex_blog_author) ): ?>
    ...
    <?php if ( !empty($architex_blog_cat) ): ?>
